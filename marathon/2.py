...
if __name__ == '__main__':
    ...
    book = "01"
    chapter = "001"
    assert filterBible(scripture, book, chapter) == ['01001001', '01001002']
    ...
    assert filterBible(scripture, book, chapter) == ['01002001', '01002002', '01002003']
    ...
    book = "02"
    chapter = "001"
    assert filterBible(scripture, book, chapter) == ['02001001', '02001002', '02001003']
