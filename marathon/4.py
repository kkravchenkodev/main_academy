...
if __name__ == '__main__':
    ...
    p = [3, 4, 1, 2, 5]
    q = [4, 5, 2, 3, 1]
    assert findPermutation(n, p, q) == [2, 5, 4, 1, 3]

    n = 3
    p = [3, 1, 2]
    q = [2, 1, 3]
    assert findPermutation(n, p, q) == [3, 2, 1]

    n = 10
    p = [8, 5, 4, 1, 10, 6, 9, 2, 7, 3]
    q = [7, 6, 10, 5, 1, 8, 9, 3, 2, 4]
    assert findPermutation(n, p, q) == [9, 6, 5, 2, 4, 1, 7, 10, 8, 3]
    ...
    assert findPermutation(n, p, q) == [93, 57, 9, 29, 96, 69, 100, 35, 92, 89, 95, 41, 85, 32, 42, 61, 47, 65, 49, 7, 23, 55, 70, 98, 53, 87, 18, 76, 13, 11, 60, 59, 90, 79, 25, 56, 68, 31, 19, 26, 58, 39, 84, 4, 17, 24, 22, 40, 6, 1, 67, 88, 74, 3, 73, 5, 62, 72, 52, 54, 46, 81, 91, 75, 14, 15, 12, 77, 20, 38, 21, 83, 44, 34, 97, 80, 63, 2, 50, 94, 51, 99, 27, 36, 48, 30, 33, 28, 37, 86, 16, 10, 45, 64, 71, 78, 66, 8, 82, 43]
